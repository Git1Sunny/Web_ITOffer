    ...
    $(window).load(function () {
      ...
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635560750235172731.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="http://www.itoffer.cn/Company/131#moreVideos"></a></span> <a href="recruit/company.jsp" target="_blank"> <img src="images/635170123249913750.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635086129655240312.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635508801853812771.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635386133707515461.jpg" width="990"> </a> </div>
            <div class="it-home-present">
              ...
              <div class="it-present-text" style="padding-left:185px;">
                <div class="it-line01 it-text-bom">
                  ...
                  <p class="it-line01 it-text-explain"> <span class="tn-icon it-home-arrow"></span> <a href="job.jsp" target="_blank" title=".NET软件开发工程师">.NET软件开发工程师</a> </p>
              ...
              <div class="it-present-text">
                <div class="it-line01 it-text-bom">
                  <p class="it-text-tit">职位</p>
                  <p class="it-line01 it-text-explain"> <span class="tn-icon it-home-arrow"></span> <span class="tn-helper-right tn-action"> <a href="job.jsp" target="_blank" class="tn-button tn-corner-all tn-button-text-only tn-button-semidlong"> <span class="tn-button-text">更多职位</span> </a> </span> <a href="job.jsp" target="_blank" title=".NET软件开发工程师">.NET软件开发工程师</a> </p>
      ...
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="#"></a></span> <a href="company.jsp" target="_blank"> <img src="images/635061323749843750.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635508636209238443.jpg" width="990"> </a> </div>
            <div class="it-home-present">
              <div class="tn-helper-right it-quiet">
                <p class="it-quiet-btn tn-button"> <a class="it-success-case" href="http://www.itoffer.cn/Home/SuccessCases?companyId=285" target="_blank">成功案例</a> <span class="it-line01" onmouseover="setShare('对日Cobol软件开发工程师', 'http://www.itoffer.cn/Job/001004005-68');"> <a style=" float:right;" href="#" class="jiathis jiathis_txt jtico jtico_jiathis it-share" target="_blank">分享</a> </span> </p>
              </div>
              <div class="it-present-btn"> <a class=" tn-button tn-button-home-apply" href="#"> <span class="tn-button-text">我要申请</span> </a> </div>
              <div class="it-present-text">
                <div class="it-line01 it-text-bom">
                  <p class="it-text-tit">职位</p>
                  <p class="it-line01 it-text-explain"> <span class="tn-icon it-home-arrow"></span> <span class="tn-helper-right tn-action"> <a href="#" target="_blank" class="tn-button tn-corner-all tn-button-text-only tn-button-semidlong"> <span class="tn-button-text">更多职位</span> </a> </span> <a href="#" target="_blank" title="对日Cobol软件开发工程师">对日Cobol软件开发工程师</a> </p>
                ...
                <div class="it-line01 it-text-top">
                  ...
                  <p class="it-line01 it-home-wid"> <span class="tn-explain-icon"> <span class="tn-icon it-icon-people"></span> <span class="tn-icon-text">0人已经申请</span> </span> </p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635508802169230812.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="#" target="_blank"> <img src="images/635086294253052812.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="http://www.itoffer.cn/Company/145#moreVideos"></a></span> <a href="http://www.itoffer.cn/Company/145" target="_blank"> <img src="images/635169304955382500.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <span><a class="tn-button it-button-video" href="#"></a></span> <a href="#" target="_blank"> <img src="images/635284036333940135.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="recruit/company.jsp" target="_blank"> <img src="images/635084591046656250.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="company.html" target="_blank"> <img src="images/635062155449062500.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <div class="tn-grid">
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
          <div class="tn-box-content tn-widget-content tn-corner-all">
            <div class="it-company-keyimg tn-border-bottom tn-border-gray"> <a href="#" target="_blank"> <img src="images/635084672065718750.jpg" width="990"> </a> </div>
          </div>
        </div>
      </div>
      <script type="text/javascript">
